...
Spezifikationen. Der Farbbereich deckt dabei sowohl hell als auch dunkle Farben ab.
\begin{table}[H]
	\begin{center}
		\begin{tabular}{|l|c|}
			\mytoprule
...
sowie in der Verminderung der Auflösung des Bildes gegeben. Eine Ausnahme macht der Algorithmus \textit{RADISH}, welcher keine
...
Strukturinformationen entfernt. Diese Tatsache gilt ebenfalls für die Reduzierung der Gesamtbildinformationen.
