...
Algorithmen zu Gunsten der nachstehenden Bewertungsgruppen zu definieren: \textit{FRR}, \textit{FAR}, Berechnungszeiten
...
wurde mittels der eigen konzipierten und umgesetzten Benutzerschnittstelle realisiert (vgl. Anhang~\ref{sec:appendix_b}).
\\
...
\\[1em]
Die theoretische und technische Auswertung der resultierten Ergebnisse sowie Beobachtungen wird in Abschnitt~\ref{sec:results} behandelt.
